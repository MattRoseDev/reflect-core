...
func (r *queryResolver) GetUserByUsername(ctx context.Context, input *model.GetUserByUsernameInput) (*model.User, error) {
	return service.GetUserByUsername(ctx, input)
}
